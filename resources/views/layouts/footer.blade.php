                ...
                <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                    <div class="footer-widget__column footer-widget__about">
                        ...
                        <div class="footer-widget__about-text-box">
                            <p class="footer-widget__about-text">Nafuu Loan Platform help to bring together Lenders 
                                and borrowers for better loan application</p>
                        </div>
                    ...
                    <div class="footer-widget__column footer-widget__contact clearfix">
                        ...
                        <ul class="footer-widget__contact-list list-unstyled clearfix">
                            <li>
                                ...
                                <div class="text">
                                    <p><a href="mailto:needhelp@company.com">info@nafuuloan.co.tz</a></p>
                                </div>
                            </li>
                            <li>
                                <div class="icon">
                                ...
                                <div class="text">
                                    <p>Bagamoyo road ,Victoria Dar es salaam</p>
                                </div>
                            </li>
                        </ul>
                    ...
                    <div class="footer-widget__column footer-widget__contact clearfix">
                        ...
                        <ul class="footer-widget__contact-list list-unstyled clearfix">
                            <li>
                                ...
                                <div class="text">
                                    <p><a href="mailto:needhelp@company.com">About Us</a></p>
                                </div>
                            </li>
                            <li>
                                <div class="icon">
                                ...
                                <div class="text">
                                    <p><a href="mailto:needhelp@company.com">Services</a></p>
                                </div>
                            </li>
                            <li>
                                <div class="icon">
                                ...
                                <div class="text">
                                    <p><a href="mailto:needhelp@company.com">Lenders</a></p>
                                </div>
                            </li>
                            {{-- <li>
                                <div class="icon">
                    ...
                    <div class="footer-widget__column footer-widget__newsletter">
                        ...
                        <div class="footer-widget__phone">
                            ...
                            <div class="footer-widget__phone-text">
                                <a href="tel:9200368090">+255 (688) 000-000</a>
                                <p>Call to Our Team</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="site-footer__bottom-inner">
                        <p class="site-footer__bottom-text">© All Copyright {{ date('Y')}} by <a href="#">Bluetick</a>
                        </p>
                    </div>
                </div>
            </div>
